...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			small: { media: '(max-width: 736px)', href: '/strata/css/style-small.css', grid: { gutters: ['1.5em', 0] }, viewport: { scalable: false } },
			xsmall: { media: '(max-width: 480px)', href: '/strata/css/style-xsmall.css' }
		}
	});
